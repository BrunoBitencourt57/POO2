...
public class Grade {
    ...
    public void exibirGrade() {
        if (turmas.isEmpty()) {
            System.out.println("\nNenhuma turma alocada na grade.");
            return;
        }
    ...
    public void exibirTurmasProfessor(String nomeProfessor) {
        ...
        if (resultado.isEmpty()) {
            System.out.println("\nNenhuma turma encontrada para o professor " + nomeProfessor + ".\n");
            return;
        }

        System.out.println("\n\n===== TURMAS DO PROFESSOR " + nomeProfessor.toUpperCase() + " =====\n");
